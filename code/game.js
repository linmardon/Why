...
Level.prototype.animate = function(step, keys) {
  ...
  if (this.visStatus != null)
    this.visibilityTimer -= step;
   else if (this.visStatus == "visSet" && this.visibilityTimer < 0 )
    {this.visStatus = null;
    this.size = new Vector(1, 1);}
};
...
Hash.prototype.act = function(step){
    ...
    var wobble2Pos = Math.sin(this.wobble2) * wobbleDist2;
...
else if (level.visStatus == "visSet") {
...
if (type == 'Exit') {
  ...
  else if (type == 'invis' && this.visStatus == null) {
  this.visStatus = "visSet";
  this.visibilityTimer = 1
